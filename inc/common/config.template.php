<?php
  ...
  if ($_configSet_included_ != '#configSet_Included#') {
    ...
    config_set ('meta-keywords',    'e-marsa');
    config_set ('meta-description', 'e-market');

    config_set ('site-name', 'e-marsa');

    // Timeout for aproving authorization
    config_set ('confirm_authorize_timeout', 3*24*60*60);

    config_set ('bot-email', 'noreply@localhost.localdomain');
    ...
    config_set ('timezone', 'Asia/Yekaterinburg');
  }
?>
